...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tree.completion_text'
        db.alter_column('decisiontree_tree', 'completion_text', self.gf('django.db.models.fields.CharField')(max_length=160, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Tree.completion_text'
        raise RuntimeError("Cannot reverse this migration. 'Tree.completion_text' and its values cannot be restored.")
    ...
    models = {
        ...
        'decisiontree.tree': {
            ...
            'completion_text': ('django.db.models.fields.CharField', [], {'max_length': '160', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
