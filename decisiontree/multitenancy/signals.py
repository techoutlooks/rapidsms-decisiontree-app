...
def _create_tenant_link(instance, tenant_id):
    """Generic utility to create a tenant link for the instance."""
    link_class = utils.get_link_class_from_model(instance)
...
def create_session_tenant_link(sender, instance, **kwargs):
    ...
    _create_tenant_link(instance, tenant_id)
